"""
schemas.py - Pydantic models for automatic validation and API documentation.

Models:
  - RoleGapRequest: Validates user input
  - SuccessResponse: Standardized success wrapper
  - ErrorResponse: Standardized error wrapper
"""
