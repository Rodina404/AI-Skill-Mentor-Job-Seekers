...
from core.converters import experience_to_score, education_to_score
from core.role_library import get_skill_name

logger = logging.getLogger(__name__)


def format_skill_name(skill_id: str) -> str:
    """Convert canonical skill ID to human-readable name. Example: 'S_python' → 'Python'"""
...
def run_role_gap_analysis(
    ...
    Args:
        ...
        experience_level: Natural language experience descriptor.
        education_level: Natural language education descriptor.
        experience_score: Pre-computed experience score 0.0–1.0 (overrides level).
        education_score: Pre-computed education score 0.0–1.0 (overrides level).
