...
Readiness = 0.60 * skill_score + 0.25 * experience_score + 0.15 * education_score
...
def compute_readiness_score(
    ...
    # Weighted-additive formula: skills dominate (60%), experience (25%) and
    # education (15%) scale the score additively.
    # This avoids the "zero-trap" where a single 0 factor (e.g. no experience
    # for a fresh graduate) collapses the entire readiness to 0 regardless of
    # how many skills the candidate actually has.
    readiness = 0.60 * skill_score + 0.25 * experience_score + 0.15 * education_score
