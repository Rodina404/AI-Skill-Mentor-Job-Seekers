...
Flow:
  job_title â†’ normalize â†’ Mode A â†’ (match? YES â†’ return) + (NO â†’ Mode B)
                                    â†’ (evidence? YES â†’ return) + (NO â†’ error)
"""
...
from core.loaders import find_best_match
from core.role_library import normalize_skill_name, normalize_skills_list, get_skill_name
from core.gap_engine import run_gap_analysis
from core.retrieval_helpers import gather_evidence, normalize_weights
from core.llm import extract_skills_from_evidence
...
def run_pipeline(
    ...
    Args:
        ...
        experience_score: Experience level score 0.0â€“1.0 (default 1.0).
        education_score: Education level score 0.0â€“1.0 (default 1.0).
    ...
    if mode_a_result:
        ...
        if required_skills:
            ...
            # Role was found but contained no normalized skills â€” log and fall back to Mode B
            logger.warning(
