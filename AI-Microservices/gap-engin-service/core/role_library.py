...
# Cross-catalog bridge: maps skill IDs emitted by the normalization service
# (skills.json) to their equivalent IDs in the gap engine catalog (skills_catalog.json).
# Without this, those IDs are treated as unknown and dropped from gap matching,
# causing artificially low readiness scores.
_NORM_TO_GAP_BRIDGE: dict[str, str] = {
    "S_algo":          "S_algorithms",
    "S_ci_cd":         "S_cicd",
    "S_css":           "S_html_css",
    "S_css3":          "S_html_css",
    "S_cv":            "S_computer_vision",
    "S_datadog":       "S_monitoring",
    "S_dl":            "S_deep_learning",
    "S_docker_compose":"S_docker",
    "S_ds":            "S_algorithms",
    "S_elk_stack":     "S_monitoring",
    "S_excel":         "S_data_analysis",
    "S_github":        "S_git",
    "S_gitlab":        "S_git",
    "S_go":            "S_golang",
    "S_grafana":       "S_monitoring",
    "S_helm":          "S_kubernetes",
    "S_html":          "S_html_css",
    "S_html5":         "S_html_css",
    "S_jest":          "S_testing",
    "S_js":            "S_javascript",
    "S_keras":         "S_tensorflow",
    "S_matplotlib":    "S_data_visualization",
    "S_ml":            "S_machine_learning",
    "S_neural_networks":"S_deep_learning",
    "S_next":          "S_nextjs",
    "S_node":          "S_javascript",
    "S_plotly":        "S_data_visualization",
    "S_powerbi":       "S_data_visualization",
    "S_prometheus":    "S_monitoring",
    "S_pytest":        "S_testing",
    "S_redux":         "S_react",
    "S_rest":          "S_rest_api",
    "S_sass":          "S_html_css",
    "S_scrum":         "S_agile",
    "S_seaborn":       "S_data_visualization",
    "S_sklearn":       "S_scikit_learn",
    "S_tcp_ip":        "S_networking",
    "S_ts":            "S_typescript",
}
...
def normalize_skill_name(raw: str) -> Optional[str]:
    ...
    # Cross-catalog bridge: handle normalization service IDs that differ from
    # gap engine catalog IDs (e.g. S_js -> S_javascript, S_ts -> S_typescript)
    bridge_result = _NORM_TO_GAP_BRIDGE.get(raw.strip()) or _NORM_TO_GAP_BRIDGE.get(cleaned)
    if bridge_result:
